...
This repository includes analysis scripts along with an example dataset from a protein-ligand system. This system was studied using a nanoVNA V2 Plus4 and data was collected using NanoVNA-QT.
